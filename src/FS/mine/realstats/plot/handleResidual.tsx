    ...
    const layout: Partial<Plotly.Layout> = {
      ...
      xaxis: {
        title: {
          text:
            "Fitted values (" +
            (selectColx.value as string) +
            "/" +
            (selectColy.value as string) +
            ")",
      ...
      yaxis: {
        title: {
          text: "Residuals", // <-- Required text property
          font: { size: 14 },
        },
      },
      //   annotations: [
